...
export default async function EmpresasPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ===== TESTIMONIAL ===== */}
      <section className="bg-white py-14 lg:py-20 border-b border-surface-200">
        <div className="container-custom max-w-3xl mx-auto text-center">
          ...
          <blockquote className="text-lg lg:text-xl text-gray-700 leading-relaxed italic mb-6">
            &ldquo;Llevamos casi un año trabajando con TecnoPhone y nuestra experiencia ha sido positiva. Les hemos comprado equipos y accesorios tecnológicos de buena calidad, con entregas oportunas y una atención siempre clara y amable. Es un proveedor confiable y recomendado.&rdquo;
          </blockquote>
          <div>
            <p className="font-bold text-gray-900">Daniela Merchán</p>
            <p className="text-sm text-surface-600">Analista de Compras</p>
          </div>
        </div>
      </section>
